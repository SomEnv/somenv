#' Evaluate a k-means to the given codebook with different values of k for Shiny
#'
...
#' the cluster centroids, the total quantization error and the DB-index for each number of clusters
